...
@Component({
  selector: 'profile-diamonds',
  templateUrl: './profile-diamonds.component.html',
})
export class ProfileDiamondsComponent implements OnInit {
  static GIVEN = 'Given';
  ...
  activeTab = ProfileDiamondsComponent.RECEIVED;
  ProfileDiamondsComponent = ProfileDiamondsComponent;
  ...
  onChange(event): void {
    if (this.activeTab !== event) {
      ...
      this.showDiamondsGiven =
        this.activeTab === ProfileDiamondsComponent.GIVEN;
